  ...
  return (
    <div className="w-full h-screen sticky top-0 bg-transparent overflow-hidden">
      <Canvas camera={{ position: [18, 14, 18], fov: 45 }} gl={{ alpha: true }}>
        ...
        <Suspense fallback={null}>
          ...
          <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.05, 0]} receiveShadow>
            ...
            <meshStandardMaterial color="#050200" roughness={0.8} metalness={0.2} />
          </mesh>
      ...
      <div id="hero-text" className="absolute inset-0 pointer-events-none flex flex-col items-center justify-center text-white z-10 px-4 opacity-0 scale-95 translate-y-10">
        <h1 className="font-display text-[15vw] md:text-[12vw] font-black uppercase tracking-tighter text-center leading-[0.85] drop-shadow-2xl">
          Padel<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B00] to-orange-500">Zone</span>
        </h1>
      </div>
